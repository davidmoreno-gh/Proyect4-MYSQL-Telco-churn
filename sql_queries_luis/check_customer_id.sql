...
FROM telco_customer_churn_demographics AS dem
LEFT JOIN telco_customer_churn_location AS loc
...
SELECT dem.`Customer ID`
FROM telco_customer_churn_demographics AS dem
LEFT JOIN telco_customer_churn_services AS ser
...
SELECT dem.`Customer ID`
FROM telco_customer_churn_demographics AS dem
LEFT JOIN telco_customer_churn_status AS sta
